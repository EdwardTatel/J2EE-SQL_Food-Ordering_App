...
<%@ page import="FinalsPackage.*,java.util.List" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    <div>
        ...
        <form method="post">
            ...
            if (userId != 0 && orderNameList != null && orderPriceList != null && orderQuantityList != null) {

                OrderDao orderDao = new OrderDao();
                

                int orderId = orderDao.insertOrder(userId, orderNameList, orderPriceList, orderQuantityList);

					
                if (orderId > 0) {
                	session.setAttribute("orderNameList", null);
	    	         session.setAttribute("orderPriceList", null);
	    	         session.setAttribute("orderQuantityList", null);
	    	     %>
	    	         <h6>Order placed successfully!</h6>
	    	         <p style="color: rgb(145, 103, 158); text-align: center;">Redirecting to homepage.</p>
                ...
                out.print("Error: Session attributes are not set");
            }
	   	%>
	    </script>
		</form>
